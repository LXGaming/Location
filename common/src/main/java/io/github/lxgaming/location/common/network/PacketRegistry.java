...
public enum PacketRegistry {
    ...
    CLIENTBOUND("Clientbound") {
        {
            // Player Position
            registerPacket(0x11, 756, 755, PacketHandler::handleClientPlayerPosition);
            ...
            // Player Rotation
            registerPacket(0x13, 756, 755, PacketHandler::handleClientPlayerRotation);
    ...
    SERVERBOUND("Serverbound") {
        {
            // Join Game
            registerPacket(0x26, 756, 755, PacketHandler::handleServerJoinGame);
            ...
            // Player Position & Rotation
            registerPacket(0x38, 756, 755, PacketHandler::handleServerPlayerPositionRotation);
            ...
            // Respawn
            registerPacket(0x3D, 756, 755, PacketHandler::handleServerRespawn);
